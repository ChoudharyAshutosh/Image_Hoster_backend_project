...
public class SignupController {
    ...
    public ResponseEntity<SignupUserResponse> userSignup(final SignupUserRequest signupUserRequest) {
        ...
        return new ResponseEntity<SignupUserResponse>(userResponse, HttpStatus.CREATED); //returning id and a message as response with 201 ac http code
    }
}
